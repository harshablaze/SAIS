...
if(isset($_REQUEST['action']))
{
	...
	if($_POST['action']=='delete')
	{
		...
		if($res)
			header('location:ebooks.php?deleted=1');
		else
			header('location:ebooks.php?deleted=0');
		exit;
	}	
}
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" >Upload E-books</h4>
			</div>
			<div class="modal-body">
				<form method="POST" action="ebooks.php"  enctype="multipart/form-data" >
...
<div class="modal fade" id="delete_cert_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" >Delete E-books</h4>
			</div>
			<div class="modal-body">
				<div class="col-md-12">
					<h4>Are You Sure To Delete this E-books?</h4>
				</div><br><br>	
				<form method="POST" id="delete_certificate_form" action="ebooks.php"  enctype="multipart/form-data" >	
